...
# 检查 roms\\cps1 文件夹里面 ROM 文件，是否和 CPS1.ini 中的文件名称一致
check_roms_is_in_ini_file(
    "roms\\cps1", "wiiflow\\plugins_data\\CPS1\\CPS1.ini", "CPS1")
check_roms_in_ini_file_is_exist(
    "roms\\cps1", "wiiflow\\plugins_data\\CPS1\\CPS1.ini", "CPS1", ("cps1frog", "ganbare", "pokonyan"))

# 检查 roms\\cps2 文件夹里面 ROM 文件，是否和 CPS2.ini 中的文件名称一致
check_roms_is_in_ini_file(
    "roms\\cps2", "wiiflow\\plugins_data\\CPS2\\CPS2.ini", "CPS2")
check_roms_in_ini_file_is_exist(
    "roms\\cps2", "wiiflow\\plugins_data\\CPS2\\CPS2.ini", "CPS2")

# 检查 roms\\cps3 文件夹里面 ROM 文件，是否和 CPS3.ini 中的文件名称一致
check_roms_is_in_ini_file(
    "roms\\cps3", "wiiflow\\plugins_data\\CPS3\\CPS3.ini", "CPS3")
check_roms_in_ini_file_is_exist(
    "roms\\cps3", "wiiflow\\plugins_data\\CPS3\\CPS3.ini", "CPS3")
